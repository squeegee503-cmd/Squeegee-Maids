  ...
  return (
    <section id="top" className="relative overflow-hidden pt-32 pb-20 md:pt-40 md:pb-28">
      ...
      <div className="absolute inset-0">
        <img
          src="/assets/hero_squeegeemaids.png"
          alt="Squeegee Maids cleaners working in a bright kitchen"
      ...
      <div className="container relative grid gap-12 lg:grid-cols-2 lg:items-center">
        <div className="flex flex-col gap-6 animate-fade-in-up">
          <div className="inline-flex items-center gap-2 self-start rounded-full border border-white/30 bg-white/15 px-4 py-1.5 text-sm font-medium text-white backdrop-blur-sm">
            <Star className="h-4 w-4 fill-yellow-400 text-yellow-400" />
            <Star className="h-4 w-4 fill-yellow-400 text-yellow-400" />
            <Star className="h-4 w-4 fill-yellow-400 text-yellow-400" />
            <Star className="h-4 w-4 fill-yellow-400 text-yellow-400" />
            <Star className="h-4 w-4 fill-yellow-400 text-yellow-400" />
            <span className="ml-1 text-white/90">Trusted by Portland homeowners</span>
          </div>

          <h1 className="text-4xl font-extrabold leading-tight tracking-tight text-balance text-white sm:text-5xl lg:text-6xl">
            Fast, Reliable Home Cleaning in{" "}
            <span className="text-sky-300">Portland.</span>
          </h1>

          <p className="text-lg text-white/80 text-pretty max-w-xl">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center pt-2">
            ...
            <Button asChild variant="outline" size="lg" className="rounded-full text-base border-white/50 bg-white/10 text-white hover:bg-white/20 backdrop-blur-sm">
